...
| `CatBoostError: Can't create train working dir` | processos do GridSearchCV disputando a mesma pasta de log | `allow_writing_files: false` em `parameters_modelling.yml` (já aplicado nesta cópia) |
